...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- TITLE -->
		<title>Portal PPDB MAN 3 Sleman - Yogyakarta</title>
							...
							<div class="container">
								<div class="main-sidemenu navbar px-0">
									<a class="navbar-brand ps-0 d-none d-lg-block" href="index.html">
										<img alt="" class="logo-2" src="../assets/images/brand/logo.webp">
									...
									<div class="header-nav-right d-flex">
										...
										<a href="/login" class="btn btn-pill btn-primary btn-w-md py-2 my-auto d-lg-none d-xl-block d-block">
											Login
										</a>
									</div>
								</div>
